...
CREATE OR REPLACE PROCEDURE sp_legal_dong_migrate_from_temp(IN p_operator_id text DEFAULT 'DBEAVER')
LANGUAGE plpgsql
AS $$
DECLARE
...
BEGIN
	...
	RAISE NOTICE 'legal_dong migrate done: input_codes=%, upsert_effected=%, past_emndn_updated=%, past_li_updated=%',
